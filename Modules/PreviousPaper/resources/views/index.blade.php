...
@section('meta_title', isset($title) ? $title : 'Previous Pappers')
@section('contant')
            ...
            <div class="col-xl-8 ">
                ...
                <div class="card shadow row">
                    ...
                    <div class="card-header border-bottom">
                        <h5 class="card-header-title">Previous Papper</h5>
                    </div>

                    <!-- Card body START -->
                    <div class="card-body">
                        <form action="{{route('admin.previouspaper.paper.fiilter')}}" class="row g-4" method="GET">
                            ...
                            <div class="d-sm-flex justify-content-end">
                                <button type="submit" class="btn btn-primary mb-0">Create Previous Paper</button>
                            </div>
                        </form>
                    </div>
                    <!-- Card body END -->
