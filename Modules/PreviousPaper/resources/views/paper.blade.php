...
@section('meta_title', isset($title) ? $title : 'Previos Pappers')
@section('contant')
    ...
    <div class="page-content-wrapper border">
        <div class="row mb-3">
            <div class="col-12 d-sm-flex justify-content-between align-items-center">
                <h1 class="h3 mb-2 mb-sm-0"><span class="h4">Previos Paper of 👉 {{ $categories->name }} </span></h1>

                <a href="{{ route('admin.previouspaper.create', $categories->id) }}"
                    ...
                    <table class="table table-dark-gray align-middle p-4 mb-0 table-hover" id="myTable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="border-0">Published</th>
                        ...
                        <tbody>
                            @foreach ($papers as $key => $row)
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    <td>{{ $row->name }}</td>
                                    <td><a class="btn btn-primary btn-sm" href="{{ app('url')->asset($row->file) }}" target="_blank">Click me</a></td>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.previouspaper.edit',$row->id) }}" 
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    <h5 class="modal-title text-white" id="addTopicLabel">{{ __('Delete Papper') }}</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.previouspaper.delete') }}" method="post">
                        @csrf
    ...
    @push('custom_js')
        ...
        <script>
            ...
            function update_status(el) {
                ...
                let url  ="{{route('admin.previouspaper.status_enable_disable')}}"
