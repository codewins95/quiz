...
@section('meta_title', isset($title) ? $title : 'Previous Paper edit')
@section('contant')
        ...
        <div class="row d-flex justify-content-center g-4">
            ...
            <div class="col-xl-10">
                <div class="card shadow">
                    ...
                    <div class="card-header border-bottom">
                        <div class="mb-3">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <h5 class="card-header-title">Previous Paper edit</h5>
                    ...
                    <!-- Card body START -->
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.previouspaper.update',$paper->id) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <input type="hidden" name="categoryId" value="{{$paper->category_id }}">
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-4 control-label">
                                    <a class="btn btn-primary btn-sm" href="{{ app('url')->asset($paper->file) }}" target="_blank">Click me</a>
                                    @error('file')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" row="3" id="description" name="description">{{ old('description',$paper->description) }}</textarea>
                                </div>
                                <div class="col-sm-4 control-label">
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary mb-0">Update Paper</button>
                            </div>
                        </form>
                    </div>
