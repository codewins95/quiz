...
@section('meta_title', isset($title) ? $title : 'Student Edit')
@section('contant')
        ...
        <div class="row d-flex justify-content-center g-4">
            ...
            <div class="col-xl-10">
                <div class="card shadow">
                    ...
                    <div class="card-header border-bottom">
                        <div class="mb-3">
                            <div class="d-sm-flex justify-content-between align-items-center">
                                <h5 class="card-header-title">Student edit</h5>
                    ...
                    <!-- Card body START -->
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.student.update',$student->id) }}" method="post"
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-6">
                                    <select name="active" id="active" class="form-control">
                                        ...
                                        <option value="0" {{ old('active',$student->active) == 0 ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                </div>
                                <div class="col-sm-4 control-label">
