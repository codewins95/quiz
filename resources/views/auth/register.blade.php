@extends('layouts.app')
@section('meta_title', isset($title) ? $title : 'Register')
@section('content')
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        @error('name') is-invalid @enderror"
                                            ...
                                            autofocus id="exampleInputName" placeholder="Name">
                                    </div>
                                    @error('name')
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="password"
                                            ...
                                            name="password" required autocomplete="password" id="inputPassword5"
                                            placeholder="*********">
                                    </div>
                                    @error('password')
                                        <span class="text-danger" role="alert">
