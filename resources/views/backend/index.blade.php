                ...
                <div class="card card-body bg-warning bg-opacity-15 p-4 h-100">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <span class="mb-0 h6 fw-light">Total Student</span>
                        </div>
                        <!-- Icon -->
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h2 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="1600"
                                data-purecounter-delay="200">0</h2>
                            <span class="mb-0 h6 fw-light">Publish Quiz</span>
                        </div>
                        <!-- Icon -->
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h2 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="1235"
                                data-purecounter-delay="200">0</h2>
                            <span class="mb-0 h6 fw-light">Income/Monthly</span>
                        </div>
                        <!-- Icon -->
                ...
                <div class="card card-body bg-success bg-opacity-10 p-4 h-100">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <span class="mb-0 h6 fw-light">Order</span>
                        </div>
                        <!-- Icon -->
            ...
            <div class="col-xxl-4">
                <div class="card shadow h-100">
                    ...
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center p-4">
                        <h5 class="card-header-title">Recent Publish test </h5>
                        ...
                        <div class="d-flex justify-content-between position-relative">
                            <div class="d-sm-flex">
                                ...
                                <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                    <h6 class="mb-0"><a href="#" class="stretched-link">Dennis
                                            Barrett</a></h6>
                                    <p class="mb-0"><b>Webestica</b> assign you a new ticket for <b>Eduport
                                            theme</b></p>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6 col-xxl-4">
                <div class="card shadow h-100">
                    ...
                    <!-- Card header -->
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center p-4">
                        <h5 class="card-header-title">Top Test @livewireStyles</h5>
                        <a href="#" class="btn btn-link p-0 mb-0">View all</a>
                    </div>
            ...
            <div class="col-lg-6 col-xxl-4">
                <div class="card shadow h-100">
                    ...
                    <!-- Card header -->
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center p-4">
                        <h5 class="card-header-title">Performance</h5>
                        <a href="#" class="btn btn-link p-0 mb-0">View all</a>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <ul class="list-group list-group-borderless mt-3">
                            <li class="list-group-item"><i class="text-primary fas fa-circle me-2"></i>
                            New User</li>
                            <li class="list-group-item"><i class="text-success fas fa-circle me-2"></i>
                            Test </li>
                            <li class="list-group-item"><i class="text-warning fas fa-circle me-2"></i>Order</li>
                            <li class="list-group-item"><i class="text-danger fas fa-circle me-2"></i>
                            Download
                            </li>
                        </ul>
                    </div>
