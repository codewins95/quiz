            ...
            <div class="d-flex align-items-center d-xl-none">
                <a class="navbar-brand" href="index.html">
                    <img class="light-mode-item navbar-brand-item h-30px"
                        src="{{ static_asset('assets/images/logo-mobile.svg') }}" alt="">
                    <img class="dark-mode-item navbar-brand-item h-30px"
                        src="{{ static_asset('assets/images/logo-mobile-light.svg') }}" alt="">
                </a>
            </div>
            <!-- Logo END -->
            ...
            <div class="ms-xl-auto">
                <ul class="navbar-nav flex-row align-items-center">
                    ...
                    <li class="nav-item ms-2 ms-sm-3 d-none d-sm-block">
                        <a class="btn btn-light btn-round mb-0" href="javascript:void(0);" onclick="openFullscreen();"> <i class="bi bi-arrows-fullscreen fa-fw"></i></a>
                    </li>
                                                ...
                                                <div class="me-3">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{ static_asset('assets/images/avatar/08.jpg') }}"
                                                            alt="avatar">
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <li>
                                            <a href="#"
                                                ...
                                                <div class="me-3">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{ static_asset('assets/images/avatar/02.jpg') }}"
                                                            alt="avatar">
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <li>
                                            <a href="#"
                                                ...
                                                <div class="me-3">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img rounded-circle"
                                                            src="{{ static_asset('assets/images/avatar/05.jpg') }}"
                                                            alt="avatar">
                                                    </div>
                                                </div>
                                                <div>
                    ...
                    <li class="nav-item ms-2 ms-md-3 dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                            ...
                            <!-- Links -->
                            <li><a class="dropdown-item" href="{{route('admin.generalsettings.index')}}"><i class="bi bi-person fa-fw me-2"></i>Edit
                                    Profile</a></li>
                            <li><a class="dropdown-item" href="{{route('admin.generalsettings.index')}}"><i class="bi bi-gear fa-fw me-2"></i>Account
                                    Settings</a></li>
