    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3">
                <!-- logo -->
                <a class="me-0" href="">
                    <img class="h-40px" src="https://hoverbusinessservices.com/images/HBS-Logo.png" alt="logo">
                </a>
                <p class="my-3 text-body-secondary"> We are on a mission to reshape the process of how students prepare
                    online for competitive exams </p>
                <!-- Social media icon -->
            ...
            <div class="col-lg-6">
                <div class="row g-4">
                    ...
                    <div class="col-6 col-md-4">
                        <h5 class="mb-2 mb-md-4 text-white">Importent Link</h5>
                    ...
                    <div class="col-6 col-md-4">
                        ...
                        <ul class="nav flex-column text-primary-hover">
                            <li class="nav-item"><a class="nav-link" href="blog.php">News and Blogs</a></li>
            ...
            <div class="col-lg-3">
                ...
                <p class="mb-0 text-body-secondary">Email:<span
                        class="h6 fw-light text-white ms-2">example@gmail.com</span></p>
        ...
        <div class="py-3">
            <div class="container px-0">
                <div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    <!-- copyright text -->
                    <div class="text-body-secondary"> Copyrights ©{{date('Y')}} TextBook. Build by <a href=""
                            class="text-body-secondary text-primary-hover">Hover Business Services</a>. </div>
                    <!-- copyright links-->
