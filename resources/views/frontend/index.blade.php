...
@section('content')
            ...
            <div class="row align-items-center justify-content-xl-between g-4 g-md-5">
                ...
                <div class="col-lg-7 col-xl-5 position-relative z-index-1 text-center text-lg-start mb-2 mb-md-9 mb-xl-0">
                    ...
                    <h6 class="mb-3 font-base bg-primary bg-opacity-10 text-primary py-2 px-4 rounded-2 d-inline-block">Get
                        started with us</h6>
                    <!-- Title -->
                    <h3 class="mb-4 display-5">One Destination
                        <span class="position-relative d-inline-block">For Preparation
                            <!-- SVG decoration -->
                    ...
                    <!-- Content -->
                    <p class="mb-3">The most reliable online Test Series in SSC Exam, Banking Exam, UPSSC Exam , and
                        Railway Exam .
                    </p>
                    <!-- Search bar -->
                    <form class="border rounded p-2 mb-4">
                        <div class="input-group">
                            <input class="form-control border-0 me-1" type="search" placeholder="Find your test">
                                ...
                                <div class="ms-3">
                                    <div class="d-flex">
                                        <h4 class="purecounter fw-bold mb-0" data-purecounter-start="0"
                                            data-purecounter-end="600" data-purecounter-delay="100">0</h4>
                ...
                <div class="col-lg-5 col-xl-6 text-center position-relative">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="avatar">
                                <img class="avatar-img rounded-circle shadow"
                                    src="{{ static_asset('assets/images/avatar/04.jpg') }}" alt="avatar">
                            </div>
                            <!-- Info -->
                            <div class="text-start ms-3">
                                <h6 class="mb-0">Join Today Test</h6>
                    ...
                    <div
                        ...
                        <div class="card card-body shadow p-4 rounded-3 d-inline-block position-relative z-index-1">
                            ...
                            <ul class="avatar-group mb-2">
                                ...
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle"
                                        src="{{ static_asset('assets/images/avatar/02.jpg') }}" alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle"
                                        src="{{ static_asset('assets/images/avatar/03.jpg') }}" alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
                    ...
                    <div class=" position-relative">
                        ...
                        <!-- Image -->
                        <img src="{{ static_asset('assets/images/element/06.png') }}"
            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="bg-body shadow rounded-3 text-center p-4 position-relative">
                        ...
                        <p class="text-truncate-2 mb-2">that contain questions similar to the real exam and detailed answer
                ...
                <div class="col-sm-6 col-xl-4">
                    <div class="bg-body shadow rounded-3 text-center p-4 position-relative">
                        <!-- Image -->
                        <img src="{{ static_asset('assets/images/element/instructor-course.svg') }}" class="h-100px mb-3"
                            alt="">
                        <!-- Title -->
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12 mx-auto text-center">
                    <h2 class="fs-1">Top Listed Test Series</h2>
                            ...
                            <div class="card border bg-transparent p-2 h-100">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <!-- Image -->
                                        <img src="{{ static_asset('assets/images/courses/4by3/08.jpg') }}"
                                            class="card-img-top" alt="course image">
                                    </div>
                                </div>
                                <!-- Card body -->
                                <div class="card-body">
                                    <h5 class="card-title fw-normal"><a href="" class="stretched-link">Sketch from
                            ...
                            <div class="card border bg-transparent h-100 p-2">
                                ...
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover"><!-- Image -->
                                        <img src="{{ static_asset('assets/images/courses/4by3/02.jpg') }}"
                                            class="card-img-top" alt="course image">
                                    </div>
                                </div>
                                <!-- Card body -->
                        ...
                        <div>
                            <div class="card border bg-transparent h-100 p-2">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <!-- Image -->
                                        <img src="{{ static_asset('assets/images/courses/4by3/03.jpg') }}"
                                            class="card-img-top" alt="course image">
                                    </div>
                                </div>
                                <!-- Card body -->
                        ...
                        <div>
                            <div class="card border bg-transparent h-100 p-2">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <!-- Image -->
                                        <img src="{{ static_asset('assets/images/courses/4by3/11.jpg') }}"
                                            class="card-img-top" alt="course image">
                                    </div>
                                </div>
                                <!-- Card body -->
                        ...
                        <div>
                            <div class="card border bg-transparent h-100 p-2">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <!-- Image -->
                                        <img src="{{ static_asset('assets/images/courses/4by3/06.jpg') }}"
                                            class="card-img-top" alt="course image">
                                    </div>
                                </div>
                                <!-- Card body -->
    ...
    <section>
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h2>Explore by Your Target Exam</h2>
                    <p class="mb-0">Get exam-ready with concepts, questions and study notes as per the latest pattern</p>
                </div>
            </div>
                    ...
                    <div class="bg-light rounded-3 p-4">
                        ...
                        <div class="tiny-slider arrow-round arrow-creative arrow-blur arrow-hover py-1">
                            <div class="tiny-slider-inner" data-autoplay="true" data-gutter="80" data-arrow="true"
                                ...
                                <div>
                                    <div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
                                        <img src="{{ static_asset('assets/images/element/bankin.webp') }}" class="h-40px"
                                            alt="">
                                        <a href="#" class="text-primary-hover stretched-link"><span
                    ...
                    <div class="card card-body shadow rounded-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="icon-lg bg-success bg-opacity-10 rounded-circle text-success"><img
                                    src="{{ static_asset('assets/images/element/ssc.webp') }}" alt=""></div>
                            <div class="ms-3">
                                <h5 class="mb-0"><a href="#" class="stretched-link">SSC Selection Post</a></h5>
                    ...
                    <div class="bg-secondary rounded-3 bg-opacity-10 p-5 h-100">
                        ...
                        <div class="row">
                            <div class="col-sm-8 position-relative">
                                ...
                                <p class="mb-3 h5 fw-light lead">Enroll now in the most popular and best rated Test Series.
                                </p>
    ...
    <!-- =======================
                                  User login content START -->
    <section class="pt-0 pt-lg-5">
        <div class="container">
            <!-- Title -->
            <div class="row mb-4">
                <div class="col-12">
                    <h2 class="mb-0">Free Study Material </h2>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-xl-6">
                    <div class="card p-2 bg-transparent border">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="{{ static_asset('assets/images/courses/4by3/01.jpg') }}" class="rounded-2"
                                    alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="dropdown flex-shrink-0">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end min-w-auto"
                                                ...
                                                <li><a class="dropdown-item" href="#">Upgrade Test Series</a></li>
                                                <li><a class="dropdown-item" href="#">Rate Test Series</a></li>
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title mt-3 mb-0"><a href="#">The Complete Digital Marketing Test
                                            Series</a></h5>
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <ul class="list-inline mb-0 justify-content-center justify-content-lg-start">
                                            <li class="list-inline-item text-white me-2"> <i
                                                    class="bi bi-check-circle-fill text-success me-2"></i>Free registration
                                            </li>
                                            <li class="list-inline-item text-white me-2"> <i
                                                    class="bi bi-check-circle-fill text-success me-2"></i>Powerful features
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- Content and input -->
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="row mb-4 align-items-center">
                        ...
                        <!-- Title -->
                        <div class="col-md-4">
                            <h2 class="mb-0">All Listed Books</h2>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xxl-3">
                            <div class="card p-2 shadow h-100">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <!-- Image -->
                                        <img src="{{ static_asset('assets/images/book/05.jpg') }}" class="card-img-top"
                                            alt="course image">
                                    </div>
                                    <!-- Hover element -->
                                    <div class="card-img-overlay">
                                ...
                                <div class="card-body px-2">
                                    ...
                                    <hr>
                                    <!-- Title -->
                                    <h6 class="card-title"><a href="#">Responsive Web Design (Paperback)</a></h6>
                                    <!-- Badge and Price -->
                                    <div class="d-flex justify-content-between align-items-center mb-0">
                                        <div><a href="#" class="badge bg-info bg-opacity-10 text-info me-2"><i
                        ...
                        <div class="col-md-6 col-lg-4 col-xxl-3">
                            <div class="card p-2 shadow h-100">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <!-- Image -->
                                        <img src="{{ static_asset('assets/images/book/07.jpg') }}" class="card-img-top"
                                            alt="course image">
                                    </div>
                                    <!-- Hover element -->
                                    <div class="card-img-overlay">
                                ...
                                <div class="card-body px-2">
                                    ...
                                    <hr>
                                    <!-- Title -->
                                    <h6 class="card-title"><a href="#">Learning Python, Fourth Edition (PDF
                                            Book)</a></h6>
                                    <!-- Badge and Price -->
                                    <div class="d-flex justify-content-between align-items-center mb-0">
                                        <div><a href="#" class="badge bg-info bg-opacity-10 text-info me-2"><i
                        ...
                        <div class="col-md-6 col-lg-4 col-xxl-3">
                            <div class="card p-2 shadow h-100">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <!-- Image -->
                                        <img src="{{ static_asset('assets/images/book/06.jpg') }}" class="card-img-top"
                                            alt="course image">
                                    </div>
                                    <!-- Hover element -->
                                    <div class="card-img-overlay">
                                ...
                                <div class="card-body px-2">
                                    ...
                                    <hr>
                                    <!-- Title -->
                                    <h6 class="card-title"><a href="#">Perfect Genius Worksheets for Class 5
                                            (Paperback)</a></h6>
                                    <!-- Badge and Price -->
                                    <div class="d-flex justify-content-between align-items-center mb-0">
                                        <div><a href="#" class="badge bg-info bg-opacity-10 text-info me-2"><i
                        ...
                        <div class="col-md-6 col-lg-4 col-xxl-3">
                            <div class="card p-2 shadow h-100">
                                ...
                                <div class="card-body px-2">
                                    ...
                                    <hr>
                                    <!-- Title -->
                                    <h6 class="card-title"><a href="#">HTML and CSS: Design and Build Websites
                                            (Compact Disk)</a></h6>
                                    <!-- Badge and Price -->
                                    <div class="d-flex justify-content-between align-items-center mb-0">
                                        <div><a href="#" class="badge bg-info bg-opacity-10 text-info me-2"><i
                    ...
                    <div class="tiny-slider-inner" data-autoplay="true" data-edge="5" data-arrow="true"
                        ...
                        <div>
                            <div class="bg-body text-center p-4 rounded-3 border border-1 position-relative">
                                ...
                                <div class="avatar avatar-lg mb-3">
                                    <img class="avatar-img rounded-circle"
                                        src="{{ static_asset('assets/images/avatar/05.jpg') }}" alt="avatar">
                                </div>
                                <!-- Title -->
                        ...
                        <div>
                            <div class="bg-body text-center p-4 rounded-3 border border-1 position-relative">
                                ...
                                <div class="avatar avatar-lg mb-3">
                                    <img class="avatar-img rounded-circle"
                                        src="{{ static_asset('assets/images/avatar/07.jpg') }}" alt="avatar">
                                </div>
                                <!-- Title -->
                        ...
                        <div>
                            <div class="bg-body text-center p-4 rounded-3 border border-1 position-relative">
                                ...
                                <div class="avatar avatar-lg mb-3">
                                    <img class="avatar-img rounded-circle"
                                        src="{{ static_asset('assets/images/avatar/09.jpg') }}" alt="avatar">
                                </div>
                                <!-- Title -->
